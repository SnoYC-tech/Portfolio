...
const Hero = () => {
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center relative pt-16 pb-16 md:py-20 lg:py-24 px-6 md:px-20 lg:px-32 border-b border-white/5 overflow-hidden">
